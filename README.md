...
<div align="center">
  ...
  <img src="kc_logo.svg" alt="logo" width="140"  height="auto" />
  <br/>
...
```
  git clone git@github.com:Kccendana/Hello_world.git
  cd Hello_world
```
...
- [ ] **Add different sections for the website**
- [ ] **Add navigation**
...
Feel free to check the [issues page](https://github.com/Kccendana/Hello_world/issues).
...
If you like this project feel free to follow this project.
...
I would like to thank Microverse for giving me opportunity to learn and develop my skills in Web Development.
